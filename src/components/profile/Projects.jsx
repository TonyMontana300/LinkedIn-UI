    ...
    <div className="pt-6 px-6 bg-white rounded-xl shadow-sm hover:shadow-lg hover:shadow-gray-300 shadow-gray-300 transition-shadow duration-200">
      ...
      <div>
        ...
        <Link to="#" className="flex items-center gap-4 mt-4 mb-7">
          <div className="h-14 w-45 bg-[#F8FAFD] flex justify-center items-center rounded-md border border-gray-200">
            <svg
              width="22px"
              height="22px"
              viewBox="0 0 24 24"
          ...
          <p>
            <p className="text-gray-950 text-sm font-semibold">📖 CodeBook – Handwriting Online Compiler</p>
