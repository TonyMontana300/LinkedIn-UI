...
const Navbar = () => {
  ...
  return (
    <nav className="nav flex justify-between items-center px-3 pt-3 mb-10 max-w-6xl mx-auto opacity-0 animate-[slideDown_0.6s_ease_forwards]">
      <Logo />
      <div className="flex gap-8 items-center">
        <ul className="flex gap-8 items-center list-none opacity-0 animate-[fadeIn_0.5s_ease_0.2s_forwards]">
          ...
          >
            <HoverIcons ref={learningRef} animation={learningAnim} size={35} />
            <Link
              to="#"
              className="text-sm text-gray-600 hover:text-gray-800 font-semibold"
            >
